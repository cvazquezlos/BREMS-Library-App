...
(function (h) {
    ...
    (function (f) {
        ...
        r(h.lang, {
            imprimirGrafico: "Imprimir gráfico",
            descargarPNG: "Descargar imagen PNG",
            descargarJPEG: "Descargar imagen JPEG",
            descargarPDF: "Descargar documento PDF",
            descargarSVG: "Descargar imagen vectorial SVG",
            ...
            buttons: {
                contextButton: {
                    ...
                    menuItems: [{
                            ...
                            textKey: "descargarPNG",
                            onclick: function () {
                                this.exportChart()
                            }
                        }, {
                            textKey: "descargarJPEG",
                            onclick: function () {
                                this.exportChart({
                                    type: "image/jpeg"
                                })
